...
export default function Analytics() {
  ...
  const fetchYouTubeAnalytics = async (userId: string, forceRefresh = false) => {
    ...
    try {
      ...
      if (response.ok) {
        console.log('Analytics data structure:', data.analytics); // Debug log
        setYoutubeAnalytics(data.analytics);
        setOriginalAnalytics(data.analytics); // Store original data for filtering
      ...
      <main className="main-content">
                  ...
                  <div style={{marginTop: '1.5rem'}}>
                    ...
                    <div style={{display: 'flex', gap: '0.75rem', flexWrap: 'wrap'}}>
                      {[
                        ...
                        {label: 'This Year', days: Math.floor((new Date() - new Date(new Date().getFullYear(), 0, 1)) / (1000 * 60 * 60 * 24)), icon: 'fas fa-calendar-year'}
                      ].map((preset) => (
                        <button
                          key={preset.label}
                          onClick={() => {
        ...
        {error && (
          <div style={{
            ...
            <strong>YouTube Connection Issue:</strong> {error}
            <div style={{marginTop: '0.5rem'}}>
              <a href="/connect" style={{color: '#007bff', textDecoration: 'underline'}}>
                → Go to Connect page to link your YouTube account
              </a>
            </div>
            <div style={{marginTop: '0.25rem', fontSize: '0.9rem', opacity: 0.8}}>
              Make sure you're connecting YouTube with the same account you're currently logged in with.
            </div>
          </div>
        )}
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <div>
                    <div style={{
                      ...
                      {formatNumber(youtubeAnalytics.channelMetrics?.subscriberCount)}
                    </div>
                    <div style={{
                      fontSize: '1.2rem',
                      opacity: 0.9,
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <div>
                    <div style={{
                      ...
                      {formatNumber(youtubeAnalytics.channelMetrics?.totalVideoCount)}
                    </div>
                    <div style={{
                      fontSize: '1.2rem',
                      opacity: 0.9,
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <div>
                    <div style={{
                      ...
                      {formatNumber(youtubeAnalytics.channelMetrics?.totalViewCount)}
                    </div>
                    <div style={{
                      fontSize: '1.2rem',
                      opacity: 0.8,
            ...
            {youtubeAnalytics.topVideos && youtubeAnalytics.topVideos.length > 0 && (
              <div style={{
                ...
                <div style={{display: 'grid', gap: '1.5rem'}}>
                  {youtubeAnalytics.topVideos.slice(0, 5).map((video: any, index: number) => (
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <i className="fab fa-youtube" style={{fontSize: '2rem', color: '#F79B72'}}></i>
                </div>
                <div>
          ...
          !loading && (
            <div style={{
              ...
              <div style={{
                ...
                justifyContent: 'center',
                margin: '0 auto 2rem',
                boxShadow: '0 20px 40px rgba(247, 155, 114, 0.3)'
              }}>
              ...
              <p style={{
                ...
                Connect your YouTube account to unlock detailed analytics, performance insights, and audience engagement data.
              </p>
              <a 
                href="/connect" 
                style={{
                  ...
                  fontSize: '1.1rem',
                  transition: 'all 0.3s ease',
                  boxShadow: '0 8px 25px rgba(247, 155, 114, 0.3)'
                }}
                onMouseOver={(e) => {
                  e.currentTarget.style.transform = 'translateY(-2px)';
                  e.currentTarget.style.boxShadow = '0 12px 35px rgba(247, 155, 114, 0.4)';
                }}
                onMouseOut={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = '0 8px 25px rgba(247, 155, 114, 0.3)';
                }}
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <i className="fas fa-calendar" style={{marginRight: '0.5rem'}}></i>
                      Published: {formatDate(selectedVideoDetail.publishedAt)}
                    </div>
